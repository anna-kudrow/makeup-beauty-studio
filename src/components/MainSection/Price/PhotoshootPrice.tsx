    ...
    <>
        ...
        <TitlePrice title="Фотосессии под ключ" subtitle="Мастер Анастасия" />
            <div className="price-table price-table__single">
                ...
                <p className="price-table__service">Полный образ + фотограф (Street)</p>
                <span className="price-table__amount">от 12000</span>
                <p className="price-table__service">Полный образ + фотограф +студия </p>
                <span className="price-table__amount">от 15000</span>
                <p className="price-table__service">Полный образ + фотограф +студия + стилист по одежде  </p>
