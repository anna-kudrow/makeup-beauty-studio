  ...
  return (
    <>
        ...
        <TitlePrice title="Услуги визажиста" subtitle="Мастер Анастасия" />
            <h3 className="title-inner-price" style={{ borderTop: "none" }}>Наращивание ресниц</h3>
            ...
            <h3 className="title-inner-price" style={{ borderTop: "none" }}>Дополнительные услуги</h3>
            <div className="price-table price-table__single">
            ...
            <h3 className="title-inner-price" style={{ borderTop: "none" }}>Образы для гостей невесты</h3>
            <div className="price-table price-table__single">
            ...
            <p className='additional-price-info'>*Выезд загород оплачивается отдельно. При сборах в центре Москвы, оплата парковки/организация парковки при отеле</p>
            <h3 className="title-inner-price">На мероприятие</h3>
            <div className="price-table price-table__single">
                <p className="price-table__service">Полный образ  (макияж +укладка) с выездом </p>
                <span className="price-table__amount">7000</span>
                <p className="price-table__service">Полный образ  (макияж +укладка) в салоне </p>
